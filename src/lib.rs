...
mod tests {
    ...
    fn run_is_cleanable_flag_found_match() {
        ...
        let artifacts = vec!["artifact_dir_1"];
    ...
    fn run_is_cleanable_flag_no_match() {
        ...
        let artifacts: Vec<&str> = vec!["artifact_dir_2"];
        assert!(!is_cleanable(&test_path, &artifacts))
    }
